...
<template>
    <div id="role-show">
        ...
        <div class="container">
            <aside class="col-aside">
                <div class="bangumi">
                    ...
                    <v-bangumi-panel class="bangumi-panel"
                                     ...
                                     @follow="handleFollowBangumiAction"></v-bangumi-panel>
                </div>
                <div class="fans">
                    ...
                    <template v-if="fans.data.length">
                        <ul>
                            ...
                            <button v-if="role.fans_count > 6"
                                    @click="openFansModal('new')"
                                    class="more-btn el-icon-more"></button>
                        </ul>
                    </template>
                    <template v-else>
            ...
            <div class="col-main">
                <div class="intro clearfix">
                    ...
                    <div class="avatar-wrap">
                        ...
                        <el-button @click="handleStarRole"
                                   type="warning"
                                   class="star"
                                   size="mini"
                                   round
                    ...
                    <div class="info">
                        ...
                        <ul class="alias">
                            <strong>别名：</strong>
                            <li v-for="(name, index) in computeRoleAlias"
                                v-text="name"
                                :key="index"></li>
                        </ul>
                        <p class="coin"
                ...
                <div class="lover"
                    ...
                    <p class="subtitle">
                        ...
                        <el-button size="mini"
                                   round
                                   @click="openFansModal('hot')">排行榜</el-button>
                    </p>
                    <a class="user"
                       target="_blank"
                ...
                <div class="images">
                    ...
                    <image-waterfall :loading="loadingRoleImageFetch"
            ...
            <v-modal v-model="toggleFansListModal"
                     :footer="false"
                ...
                <li v-for="item in fansModalData"
                    :key="item.id">
                    <a class="lover-user"
                       target="_blank"
