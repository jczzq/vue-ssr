    ...
    <div id="space3D"
        ...
        <div class="sign-modal-wrap abs"
          ...
          'sign-in-turn' : !showSignIn && showSignUp
                ...
                <div class="form-container"
                    ...
                    <img class="logo"
                         ...
                         alt="sign-logo">
                    <reset-password-form @to-login="showReset = false"
                                         @to-register="showRegister"></reset-password-form>
                </div>
                <div class="form-container"
                     v-show="!showReset">
                    <sign-in-form @to-reset="showReset = true"
                                  @to-register="showRegister"></sign-in-form>
                </div>
            </div>
          ...
          'sign-up-turn' : !showSignUp && showSignIn
                ...
                <div class="form-container">
                    <sign-up-form @to-login="showLogin"></sign-up-form>
                </div>
            </div>
        </div>
    </div>
