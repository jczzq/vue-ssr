    ...
    <div id="side-tools">
        <v-creator>
            <el-tooltip placement="top"
                        effect="dark"
                        content="图片">
                <button class="creator-btn iconfont icon-tupian"
                        @click="handleImageClick"></button>
            </el-tooltip>
            <el-tooltip placement="top"
                        effect="dark"
                        content="发帖">
                <button class="creator-btn iconfont icon-fatie1"
                        @click="handlePostClick"></button>
            </el-tooltip>
            <el-tooltip placement="top"
                        effect="dark"
                        content="反馈">
                <button class="creator-btn iconfont icon-fankui"
                        @click="showFeedModal = true"></button>
            </el-tooltip>
        </v-creator>
        <div class="creator-button-box">
            <el-tooltip placement="right"
                ...
                <transition name="el-fade-in">
                    <button v-show="showToTop"
                            id="to-top-btn"
                            class="iconfont icon-fanhuidingbu"
                            @click="$scrollToY(0)"></button>
                </transition>
            </el-tooltip>
        </div>
