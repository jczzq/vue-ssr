...
<template>
    <div id="music"
        ...
        <div class="M-main">
                    ...
                    <div class="center">
                        <div class="M-play-control">
                            ...
                            <button class="lg-btn"
                                ...
                                <i class="iconfont"
                                   :class="[ status.playing ? 'icon-icon-' : 'icon-bofang1' ]"></i>
                            </button>
                            <button class="sm-btn"
                                    @click="next(true)">
                        ...
                        <div class="M-voice-control">
                            <button class="sm-btn"
                                ...
                                <i class="iconfont"
                                   :class="[ status.silent ? 'icon-jingyin' : 'icon-zengdayinliang' ]"></i>
                            </button>
                            <span class="M-all-voice">
                                <v-range v-model="status.voice"
            ...
            <span class="M-allBar">
                <v-range v-model="status.current"
                         :max="status.duration"
                         :barsize="3"
                         :tailsize="0"
                         :disabled="true"></v-range>
            </span>
        </div>
        <div class="M-menu"
            ...
            <div class="M-menu-wrap">
                <div class="header">
                    ...
                    <button class="close"
                            @click="status.menuShow = false">&times;</button>
                </div>
                <div class="body">
                    ...
                    <div class="item"
                        ...
                        <div class="item-left">
                            <div>
                                <span v-show="item.playing"
                                      :class="['icon', status.playing ? 'icon-play' : 'icon-pause']"></span>
        ...
        return {
            source: [
                ...
                },
                {
                    ...
                    img:
                        'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=974157411,1445364173&fm=21&gp=0.jpg',
                    player: '山本润子',
                    name: '翼をください'
                },
                {
